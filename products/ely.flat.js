...
class IconView extends View {
    ...
    constructor(options) {
        ...
        this.addClass("fa");
        variableAndSet(options.iconName, this.iconName, this, "refresh");
