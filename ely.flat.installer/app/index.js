(function () {
    ...
    ***************************************************************************** */
    ...
    function execRequest(command, loadingText, data, response) {
    ...
    const workingDirectoryField = new efTextField({placeholder: "Рабочая директория"});
     ...
     * @param callback
     */
    function setWorkingDirectoryCommand(workingDirectory, callback) {
     ...
     * @param callback
     */
    function runServerCommand(callback) {
     ...
     * @param callback
     */
    function stopServerCommand(callback) {
        if (processes.runServer) return;
        processes.runServer = true;
     ...
     */
    class ConfigViewController extends elySimplePageViewController {
        viewDidLoad() {
            super.viewDidLoad();
            ...
            this.view.add(new elyControl$1({tag: "br"}));
                ...
                let navigationSettings = {
                    ...
                    options: [
                        ...
                        [
                            ...
                            new elyColorPickerField$1({value: new elyColor$1({hex: cfg.navigationBar.color})}),
                            "navigationBar/color"
                        ]
                    ]
                };
                ...
                let templateSettings = {
                    ...
                    options: [
                        ...
                        [
                            ...
                            new elyColorPickerField$1({value: new elyColor$1({hex: cfg.template.color})}),
                            "template/color"
                        ],
                        ["Подвал"],
                        [
    ...
    class IndexViewController extends elySimplePageViewController {
        ...
        viewDidLoad() {
            ...
            let serverRunGrid = this.gridCell("refresh", "Live update server",
                "Запускает сервер для тестирования, " +
     ...
     */
    class ServerViewController extends elySimplePageViewController {
