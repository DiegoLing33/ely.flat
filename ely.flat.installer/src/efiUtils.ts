/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 +                                                                            +
 + Файл: efiUtils.ts                                                          +
 + Файл изменен: 17.02.2019 21:35:21                                          +
 +                                                                            +
 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
...
export class efiUtils {
     ...
     * @param callback
     */
    public static exportToPath(a: any, path: string, callback: (err?: string) => void): void {
        efiUtils.checkExportPath(efiUtils.getModulePath() + "/" + a, result => {
            if (!result) callback(`Объект ${a} не найден в пакете efi! {Source path: ${efiUtils.getModulePath()}}`);
            else {
     ...
     */
    public static exportApplicationFilesToPath(path: string, callback: (err?: string) => void): void {
     ...
     * @param callback
     */
    public static exportResourcesFilesToPath(path: string, callback: (err?: string) => void): void {
