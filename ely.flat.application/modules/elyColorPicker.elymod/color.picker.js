...
const ColorUtils_1 = require("@core/ColorUtils");
...
(function (win, doc, NS) {
    ...
    function HSV2RGB(a) {
        const rgb = ColorUtils_1.ColorUtils.hsv2rgb({ hue: +a[0], saturation: +a[1], value: +a[2] });
    ...
    function RGB2HSV(a) {
        const res = ColorUtils_1.ColorUtils.rgb2hsv({ red: +a[0], green: +a[1], blue: +a[2] });
        return [res.hue, res.saturation, res.value];
    }
    function RGB2HEX(a) {
        return ColorUtils_1.ColorUtils.rgb2hex({ red: +a[0], green: +a[1], blue: +a[2] });
    }
    // rrggbb or rgb //ok
    // @ts-ignore
    function HEX2HSV(s) {
    ...
    (function ($) {
        ...
        $$[instance][source.id || source.name || Utils_1.default.count($$[instance])] = $;
        // trigger color picker panel on click by default
        if (!Guard_1.isSet(events) || events === true) {
            events = on_down;
        }
        // add event
        ...
        // get color data
        function get_data(a) {
            return _ || (Guard_1.isSet(a) ? a : false);
        }
        // set color data
        function set_data(a) {
            _ = a;
        ...
        function add(ev, fn, id) {
            ...
            if (!Guard_1.isSet(fn))
                return hooks[ev];
            // @ts-ignore
            if (!Guard_1.isSet(hooks[ev]))
                hooks[ev] = {};
            // @ts-ignore
            if (!Guard_1.isSet(id))
                id = Utils_1.default.count(hooks[ev]);
            // @ts-ignore
        ...
        $.fit = function (o) {
            ...
            if (typeof o === "object") {
                Guard_1.isSet(o[0]) && (left = o[0]);
                Guard_1.isSet(o[1]) && (top = o[1]);
            }
            else {
