 ...
 */
export interface NotificationViewOptions extends ViewOptions {
    ...
    /** Данные оповещений */
    notificationsData?: NotificationView[];
 ...
 * version 0.1
 */
export default class NotificationView extends Control {

    /**
     * Стандартные параметры
     */
    public static defaults: NotificationViewOptions = {
     ...
     * Заголовок
     */
    public titleView: Control;

    /**
     * Содержимое сообщения
     */
    public messageView: Control;

    /**
     * Содержимое контента
     */
    public contentView: Control;
     ...
     * Опции
     */
    public options: NotificationViewOptions;
     ...
     * @param props
     */
    constructor(props: NotificationViewOptions = NotificationView.defaults) {
        super(props);
        ...
        if (this.options.content) this.contentView.addSubView(new TextView({text: this.options.content}));
     ...
     */
    public present(): NotificationView {
