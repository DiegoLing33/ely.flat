...
import elyDataGridViewOptions from "@options/data/elyDataGridViewOptions";
 ...
 * @author Diego Ling
 */
export default class elyDataGridView<T> extends elyView {
    ...
    public update(): elyDataGridView<T> {
        ...
        for (let i = 0; i < this.rowsCount(); i++) {
            ...
            for (let j = 0; j < this.colsCount(); j++) {
                ...
                let view = elyTextView.tryMutateToView(this.itemDelegateProperty(i, j));
