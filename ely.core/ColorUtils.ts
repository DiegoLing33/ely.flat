...
export class ColorUtils {
     ...
     * @param color
     */
    public static hsv2hex(color: ColorHSV): string {
     ...
     * @param hex
     */
    public static hex2rgb(hex: string): ColorRGB {
        if (hex.length === 3) {
            hex = hex.replace(/./g, "$&$&");
        }
        return {
     ...
     * @param hex
     */
    public static hex2hsv(hex: string): ColorHSV {
     ...
     * @param color
     */
    public static rgb2hex(color: ColorRGB): string {
