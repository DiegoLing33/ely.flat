...
export class elyTextField extends elyFieldView<string> {
     ...
     * @protected
     */
    protected readonly __fieldType: elyFieldType;

    /**
     * Конструктор
     * @param {elyTextFieldOptions} props
     */
    public constructor(props: elyTextFieldOptions = {fieldType: elyFieldType.text, encrypted: false}) {
