...
import {
    efAppConfigInterface, efConfigSection_app,
    efConfigSection_contentController, efConfigSection_manifest, efConfigSection_meta,
    efConfigSection_navigationBar, efConfigSection_sideNavigationBar, efConfigSection_template,
