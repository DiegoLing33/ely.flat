var ely = (function () {
	...
	class elyUIWSWorkspace extends elyWorkspaceView_1.default {
	    ...
	    constructor() {
	         ...
	         * @protected
	         */
	        this.logger = new elyXLogger_1.default({ mainPrefix: "WS", clear: true });
	        this.getDocument().append(this.content.getDocument());
	    }
	    /**
	     ...
	     */
	    update() {
	        this.logger.log("Отрисовка рабочей области...");
	        if (!this.canUpdate)
	            return;
	        ...
	        for (const viewName in elyWSRegex_1.default.main.views.get()) {
	            if (!elyWSRegex_1.default.main.views.contains(viewName))
	                continue;
	            this.logger.log(`Отрисовка элемента [${viewName}]`);
	            ...
	            for (const afvName in placers) {
	                if (!placers.hasOwnProperty(afvName))
	                    continue;
	                this.logger.log(`Элемент [${viewName}] --> поле ${afvName}`);
	...
	class elyUIWorkshop {
	    ...
	    static create(root) {
	        ...
	        elyWSRegex_1.default.main.regView(new elyWorkspaceView_1.default(), "ws");
	        elyUIWSWorkspace_1.default.main.update();
	    ...
	    static restoreSessionFromObject(obj, callback) {
	        ...
	        elyUtils_1.default.forEach(obj.meta, (index, value) => {
	            if (elyUIWSMeta_1.default.metas.hasOwnProperty(index)) {
	                ...
	                elyUIWSMeta_1.default.metas[index][name] = {};
	            }
	        });
